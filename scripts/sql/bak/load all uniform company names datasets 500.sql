...
LOAD DATA LOCAL INFILE '//manhattan.db.toronto.edu/oktie/data/cname-datasets-500/CU1.txt'
INTO TABLE tst
...
LOAD DATA LOCAL INFILE '//manhattan.db.toronto.edu/oktie/data/cname-datasets-500/CU2.txt'
INTO TABLE tst
FIELDS TERMINATED BY ':'
LINES TERMINATED BY '\n'
(tid, id, clean, string);
...
LOAD DATA LOCAL INFILE '//manhattan.db.toronto.edu/oktie/data/cname-datasets-500/CU3.txt'
INTO TABLE tst
FIELDS TERMINATED BY ':'
LINES TERMINATED BY '\n'
(tid, id, clean, string);
...
LOAD DATA LOCAL INFILE '//manhattan.db.toronto.edu/oktie/data/cname-datasets-500/CU4.txt'
INTO TABLE tst
FIELDS TERMINATED BY ':'
LINES TERMINATED BY '\n'
(tid, id, clean, string);
...
LOAD DATA LOCAL INFILE '//manhattan.db.toronto.edu/oktie/data/cname-datasets-500/CU5.txt'
INTO TABLE tst
FIELDS TERMINATED BY ':'
LINES TERMINATED BY '\n'
(tid, id, clean, string);
...
LOAD DATA LOCAL INFILE '//manhattan.db.toronto.edu/oktie/data/cname-datasets-500/CU6.txt'
INTO TABLE tst
FIELDS TERMINATED BY ':'
LINES TERMINATED BY '\n'
(tid, id, clean, string);
...
LOAD DATA LOCAL INFILE '//manhattan.db.toronto.edu/oktie/data/cname-datasets-500/CU7.txt'
INTO TABLE tst
FIELDS TERMINATED BY ':'
LINES TERMINATED BY '\n'
(tid, id, clean, string);
...
LOAD DATA LOCAL INFILE '//manhattan.db.toronto.edu/oktie/data/cname-datasets-500/CU8.txt'
INTO TABLE tst
FIELDS TERMINATED BY ':'
LINES TERMINATED BY '\n'
(tid, id, clean, string);
