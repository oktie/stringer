...
public class RunMCenterClustering {
	...
	public static void findClustersCM(String tablename, Preprocess measure, 
	...
	public static void main(String[] args) {
		...
		double startThr = 0.1, stopThr = 0.5, step = 0.2;
		...
		for (String tablename: tables) {
			...
			while (thr < stopThr) {
				...
				findClustersCM(tablename, measure, cluster, members, thr);
