...
public class RunStarClustering {
	...
	public static void saveClusters(HashMap<Integer,BitSet> clusterNums, String tablename, String thresholdS){
		...
		String clusterTable = "Cluster_" + tablename + thresholdS; // + "_" + Preprocess.extractMetricName(measure.getClass().getName());
	...
	public static void main(String[] args) {
		...
		String algorithm = "star";
		double startThr = 0.1, stopThr = 0.91, step = 0.1;
		boolean show_times = false;

		boolean log_results_to_db = false;
		String resultsTable = "tmp_results";
		...
		*/
		...
		for (String tablename: tables) {
			...
			while (thr <= stopThr) {			
				...
				RunCLINKClustering.findClustersSTAR(tablename, measure, members, thr);
